...
<head>
	...
	<title>Lihat Biodata Admin</title>
...
<body>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-9 bg-white p-5 pt-5">
      <p class="fs-4"><i class="fas fa-list-ul" style="margin-right: 10px;"></i>Lihat Biodata</p>
            ...
            <?php
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td><?php echo $d['aboutUs'];?></td>
                    <td>
                      <a href="tampil_ubah_biodata.php?id_biodata=<?php echo $d['id_biodata']; ?>" class="btn btn-primary">Edit</a>
                      <a href="hapus_biodata.php?id_biodata=<?php echo $d['id_biodata']; ?>" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                <?php
              } ?>
