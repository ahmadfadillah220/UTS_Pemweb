...
<body>
  ...
  <div class="row no-gutters">
    ...
    <?php
      ...
      $query = "SELECT * FROM biodata WHERE id_biodata = '$id_biodata'";
    ...
    <div class="col-md-9 bg-white p-5 pt-5">
      <p class="fs-4"><i class="fas fa-address-card" style="margin-right: 10px;"></i>Edit Biodata</p>
      
      <div class="row">
        <form action="proses_ubah_biodata.php" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="id_biodata" value="<?php echo $id_biodata; ?>">
          <div class="form-group">
            <label for="exampleInputEmail1" class="form-label">Nama Lengkap</label>
            <input type="text" name="nama_lengkap" value="<?php echo $nama_lengkap; ?>" class="form-control mb-3" placeholder="Masukan Nama Lengkap">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1" class="form-label">Profile</label>
            <input type="text" name="profile" value="<?php echo $profile; ?>" class="form-control mb-3" placeholder="Masukan Profile">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control mb-3" name="about_me" placeholder="Masukan About Me"><?php echo $aboutUs; ?></textarea>
          </div>
